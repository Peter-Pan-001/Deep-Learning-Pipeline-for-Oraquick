...
output_training_dir = 'color_filter_output'
output_testing_dir = 'color_filter_output'
...
lower_red_1 = np.array([0,65,50])
upper_red_1 = np.array([10,255,255])
lower_red_2 = np.array([170,65,50])
upper_red_2 = np.array([180,255,255])
